        ...
        <>
            <div className="container" style={{ padding: '10px 0' }}>
                <div className='d-flex flex-wrap justify-content-center my-5 w-50' style={{ border: '1px solid lightGrey', margin: 'auto', borderRadius: '15px', padding: '30px 0', backgroundColor: 'white' }}>
                    ...
                    <button className="btn btn-danger col-md-10 ml-2 my-3" onClick={handleClick} >Swtich to {status.mode == 'Signup' ? 'Login' : 'SignUp'}</button>
                    <h1 className='font-weight-bold mb-5 text-center col-12'>{status.mode}</h1>
